    ...
    return (
        ...
        <div className="text-white">
            ...
            <div className="flex justify-center">
                <button
                    onClick={() => setAtTheater(true)}
                    className={[
                        "bg-gray-700 m-3 p-3 border-solid border-2 rounded-lg border-orange-500 bg-gray-700",
                        atTheater ? "bg-orange-500" : ""
                    ].join(" ")}
                >
                    In Theaters
                </button>
                <button
                    onClick={() => setAtTheater(false)}
                    className={[
                        "bg-gray-700 m-3 p-3 border-solid border-2 rounded-lg border-orange-500 bg-gray-700",
                        atTheater ? "" : "bg-orange-500"
                    ].join(" ")}
        ...
        <div className="text-white py-3">
            ...
            <div className="flex justify-center pt-2">
                <div
                    className={[
                        "text-lg text bg-gray-700 border-2 border-r-0 border-solid rounded-l-lg border-orange-500",
                        `hover:bg-orange-500 ${isTwelveHr ? "bg-orange-500" : ""} flex items-start justify-center p-1`
                    ].join(" ")}
                >
                ...
                <div
                    className={[
                        "text-lg text bg-gray-700 border-2 border-l-0 border-solid rounded-r-lg border-orange-500",
                        `hover:bg-orange-500 ${isTwelveHr ? "" : "bg-orange-500"} flex items-start justify-center p-1`
                    ].join(" ")}
                >
            ...
            <div className="flex justify-center items-center p-4">
                <div className="flex flex-col">
                    <div
                        onClick={isTwelveHr ? handleAddHour12 : handleAddHour24}
                        className={[
                            "text-3xl text bg-gray-700 border-2 border-b-0 border-solid rounded-t-lg",
                            "border-orange-500 h-7 hover:bg-orange-500 flex items-start justify-center pt-1 px-4"
                        ].join(" ")}
                    >
                        <button className="relative bottom-2 ">+</button>
                    </div>
                    <input
                        onChange={(event) => setClockHr(event.target.value)}
                        className={[
                            "[&::-webkit-inner-spin-button]:appearance-none",
                            "[&::-webkit-outer-spin-button]:appearance-none text-3xl bg-sky-950 border-solid",
                            "border-r-2 border-l-2 text-center border-orange-500 w-14 h-14"
                        ].join(" ")}
                        value={clockHr}
                        type="number"
                    />
                    <div
                        onClick={isTwelveHr ? handleSubtractHour12 : handleSubtractHour24}
                        className={[
                            "text-4xl text bg-gray-700 border-2 border-t-0 border-solid rounded-b-lg",
                            "border-orange-500 h-7 hover:bg-orange-500 flex items-start justify-center pt-1 px-4"
                        ].join(" ")}
                    >
                ...
                <div className="flex flex-col">
                    ...
                    <input
                        onChange={(event) => setClockMin(event.target.value)}
                        className={[
                            "[&::-webkit-inner-spin-button]:appearance-none",
                            "[&::-webkit-outer-spin-button]:appearance-none text-3xl bg-sky-950 border-solid",
                            "border-r-2 border-l-2 text-center border-orange-500 w-14 h-14"
                ...
                <div className={`flex flex-col pl-5 ${isTwelveHr ? "" : "hidden"}`}>
                    <div
                        ...
                        className={[
                            "px-2 text-lg text bg-gray-700 border-2 border-b-2 border-solid rounded-t-lg",
                            `border-orange-500 flex items-start justify-center pt-1 ${isPm ? "" : "bg-orange-500"}`
                        ].join(" ")}
                    >
                    ...
                    <div
                        ...
                        className={[
                            "px-2 text-lg text bg-gray-700 border-2 border-b-2 border-solid rounded-b-lg",
                            `border-orange-500 flex items-start justify-center pt-1 ${isPm ? "bg-orange-500" : ""}`
                        ].join(" ")}
                    >
